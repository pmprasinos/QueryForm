...
Public Class XTLForm
    ...
    Public Sub QueryXTL()
        ...
        Try
            ...
            XTLDataAdapter.SelectCommand.CommandText = "Select PARTNO, OPERATION_NO, OPERATION_DESCR, WC_DESC, WORKCENTER, DWELL, MILESTONE From WFLOCAL..TIMELINE with (NOLOCK) where PARTNO=@partno  ORDER BY OPERATION_NO"
